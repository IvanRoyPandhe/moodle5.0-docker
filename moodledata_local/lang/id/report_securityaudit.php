...
/**
 * Strings for component 'report_securityaudit', language 'id', version '5.0'.
 *
...
$string['Incorrectlogins'] = 'Login salah';
...
$string['check_vulsfounderror'] = 'Ditemukan kerentanan <span class=“badge badge-bahaya”>{$a}</span> untuk versi Moodle ini.';
...
$string['nisdocumentation'] = 'Dokumentasi';
