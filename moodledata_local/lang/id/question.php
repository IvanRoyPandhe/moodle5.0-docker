...
/**
 * Strings for component 'question', language 'id', version '5.0'.
 *
 * @package     question
 * @category    string
...
$string['otherbanksdesc'] = 'Aktivitas ini juga mengandung pertanyaan, tetapi tidak dapat dibagikan.';
$string['otherquestionbank'] = 'Bank soal lainnya';
$string['otherquestionbankstoomany'] = '> {$a} hasil, harap persempit pencarian Anda.';
