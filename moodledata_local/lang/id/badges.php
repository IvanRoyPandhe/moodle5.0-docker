...
/**
 * Strings for component 'badges', language 'id', version '5.0'.
 *
 * @package     badges
 * @category    string
...
$string['badgeimageinfo'] = 'Untuk hasil terbaik, unggah gambar persegi dengan ukuran minimal 300 x 300 piksel.';
...
$string['descriptioninfo'] = 'Apa yang dilambangkan oleh lencana ini?';
...
$string['fixed'] = 'Tanggal Tetap: Lencana ini berakhir pada tanggal berikut:';
...
$string['never'] = 'Tidak pernah: Lencana ini tidak kedaluwarsa.';
...
$string['relative'] = 'Tanggal relatif: Lencana ini berakhir setelah periode waktu:';
