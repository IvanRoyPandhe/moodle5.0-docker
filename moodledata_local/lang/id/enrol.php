...
/**
 * Strings for component 'enrol', language 'id', version '5.0'.
 *
 * @package     enrol
 * @category    string
...
$string['customwelcomemessage_help'] = 'Format yang diterima: Teks biasa atau format Moodle-otomatis. Tag HTML dan tag multi-bahasa juga diterima, serta <i>placeholder</i> berikut:
<ul>
