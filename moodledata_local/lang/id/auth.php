...
/**
 * Strings for component 'auth', language 'id', version '5.0'.
 *
 * @package     auth
 * @category    string
...
$string['auth_changingemailaddress'] = 'Anda telah meminta perubahan alamat email, dari {$a->oldemail} ke {$a->newemail}. Demi alasan keamanan, kami akan mengirimkan pesan email ke alamat baru tersebut untuk mengonfirmasi bahwa alamat tersebut milik Anda. Alamat email Anda akan diperbarui segera setelah Anda membuka URL yang dikirimkan kepada Anda dalam pesan tersebut. Tautan konfirmasi akan kedaluwarsa dalam <b>10 menit</b>';
...
$string['auth_loginrecaptcha_desc'] = 'Tambahkan elemen formulir konfirmasi visual/audio ke halaman login. Hal ini mengurangi risiko upaya login yang tidak beralasan. Lihat <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a> untuk detail selengkapnya.';
...
$string['emailupdatemessage'] = 'Hai {$a->nama depan},
...
{$a->url}
Tautan konfirmasi akan kedaluwarsa dalam <b>10 menit</b>.
