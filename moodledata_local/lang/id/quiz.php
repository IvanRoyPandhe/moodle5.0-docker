...
/**
 * Strings for component 'quiz', language 'id', version '5.0'.
 *
 * @package     quiz
 * @category    string
...
$string['configintroglobal'] = 'Pengaturan ini mengontrol perilaku seluruh sistem dari aktivitas Kuis.';
...
$string['defaultsettings'] = 'Pengaturan kuis bawaan';
...
$string['precreateattempts_desc'] = 'Jika diaktifkan, kuis akan memiliki upaya yang dibuat sebelum waktu pembukaan kuis,
berdasarkan “Periode pra-buat” yang juga harus diatur.

Hal ini untuk mencegah lonjakan beban server ketika siswa memulai kuis yang rumit atau banyak sekaligus.

Kuis tanpa waktu pembukaan tidak akan terpengaruh.

Jika pengaturan ini dikunci, pengaturan ini akan dipaksa aktif atau nonaktif untuk semua kuis.
Jika tidak dikunci, dan “Periode pra-buat” diatur, kuis dapat memilih untuk menggunakan fitur ini. Jika periode “Pra-buat” tidak diatur, pengaturan ini
tidak akan ditampilkan pada formulir pengaturan kuis.';
...
$string['precreateperiod'] = 'Periode pra-pembuatan';
$string['precreateperiod_desc'] = 'Periode sebelum waktu kuis dibuka, percobaan akan dibuat sebelumnya.

Percobaan dibuat oleh tugas terjadwal (mod_quiz\\task\\precreate_attempts) yang berjalan setiap jam secara bawaan.

Karena kuis tidak dapat disunting setelah memiliki percobaan, yang terbaik adalah menjaga periode ini sesingkat mungkin.
Jika Anda cenderung memiliki satu kuis atau serangkaian kuis yang dimulai pada satu waktu, periode singkat seperti 1 jam sudah cukup.

Jika Anda memiliki beberapa kuis yang dimulai pada waktu yang berbeda sepanjang hari, dan ingin semua pra-pembuatan terjadi saat sistem sedang sepi seperti
semalam, Anda dapat mengaturnya ke periode yang lebih lama seperti 12 jam dan menyesuaikan tugas terjadwal untuk berjalan selama
jam.

Pengaturan ini dikontrol di tingkat situs, tidak dapat digantikan oleh kuis individu.';
...
$string['stateoptions_help'] = '* Belum dimulai: Percobaan dibuat secara otomatis sebelum kuis dibuka. Siswa belum memulai percobaan.
* Sedang berlangsung: Siswa telah memulai percobaan. Mereka masih memiliki waktu untuk mengajukannya.
* Terlambat: Percobaan telah dibuka lebih lama dari batas waktu yang diizinkan. Siswa masih dapat mengajukannya dalam periode penilaian.
* Dikirim: Siswa telah menyelesaikan percobaan dan mengajukan tanggapan mereka. Ini mengantri untuk penilaian otomatis.
* Selesai: Percobaan telah dikirimkan dan penilaian otomatis telah selesai.
* Tidak pernah diajukan: Siswa memulai percobaan, tetapi tidak mengajukannya dalam batas waktu atau masa tenggang.';
