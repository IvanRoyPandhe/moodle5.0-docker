...
/**
 * Strings for component 'grades', language 'id', version '5.0'.
 *
 * @package     grades
 * @category    string
...
$string['errornegativepenalty'] = 'Menerima nilai negatif selama agregasi penalti untuk ID nilai {$a}';
...
$string['recalculatepenaltysuccess'] = 'Perhitungan ulang penalti berhasil dilakukan. Mungkin ada penundaan sebelum nilai diperbarui.';
