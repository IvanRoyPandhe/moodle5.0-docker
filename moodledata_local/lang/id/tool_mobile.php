...
/**
 * Strings for component 'tool_mobile', language 'id', version '5.0'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['iosappid_desc'] = 'Setelan ini dapat dibiarkan sebagai default kecuali Anda memiliki aplikasi iOS kustom.';
