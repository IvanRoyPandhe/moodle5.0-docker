...
/**
 * Strings for component 'admin', language 'id', version '5.0'.
 *
 * @package     admin
 * @category    string
...
$string['configallowedemaildomains'] = 'Daftar domain surel yang diizinkan untuk diungkapkan di bagian "Dari" dari email keluar. Bawaan "Kosong" akan menggunakan alamat Tanpa Balasan untuk semua surel keluar. Penggunaan wildcard diizinkan, mis. * .example.com akan memungkinkan surel dikirim dari subdomain example.com mana pun, tetapi bukan example.com itu sendiri. Ini akan membutuhkan entri terpisah.';
...
$string['importantupdates_content'] = '<p>Pada Moodle 5.0 berikutnya yang direncanakan rilis pada bulan April 2025, kegiatan Obrolan dan Survei akan dihapus dari inti Moodle. Mereka akan tersedia sebagai pengaya di <a href="https://moodle.org/plugins/">Direktori pengaya Moodle</a>.</p> <p>Jika Anda ingin terus menggunakan Obrolan atau Survei di situs Anda, Anda dapat menginstalnya sebagai pengaya sebelum meningkatkan ke Moodle 5.0.</p>';
...
Akun Anda dengan nama pengguna {$a->username} di server \'{$a->sitename}\' terkunci setelah beberapa kali upaya masuk yang tidak valid.
...
yang bisa Anda klik saja. Jika itu tidak berhasil,
lalu salin dan tempel alamat tersebut ke baris
alamat di bagian atas jendela peramban web Anda.
