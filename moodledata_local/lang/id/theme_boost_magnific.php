...
/**
 * Strings for component 'theme_boost_magnific', language 'id', version '5.0'.
 *
...
$string['fontfamily_menus'] = 'Font Menu';
$string['fontfamily_menus_desc'] = 'Pilih font mana yang ingin Anda gunakan untuk menu di situs Moodle Anda.';
$string['fontfamily_sitename'] = 'Font untuk nama situs';
$string['fontfamily_sitename_desc'] = 'Font yang akan diterapkan pada nama situs jika logo tidak disediakan.';
$string['fontfamily_title'] = 'Font Teks Judul';
$string['fontfamily_title_desc'] = 'Pilih font mana yang ingin Anda gunakan untuk judul di situs Moodle Anda.';
$string['fontpreview'] = 'Pratinjau Daftar Font';
...
$string['mycourses_icon_desc'] = 'Ikon representatif untuk blok. Ukuran ikon harus 48x48 piksel.';
$string['mycourses_info'] = 'Blok {$a}';
$string['mycourses_numblocos'] = 'Tidak ada blok';
$string['mycourses_numblocos_desc'] = 'Berapa banyak gambar yang ingin Anda masukkan dalam SlideShow?';
$string['mycourses_numblocos_nenhum'] = 'Tidak ada slide di halaman utama';
$string['mycourses_title'] = 'Judul Singkat Blok';
$string['mycourses_title_desc'] = 'Judul singkat dan deskriptif untuk blok.';
$string['mycourses_url'] = 'Tautan Blok';
$string['mycourses_url_desc'] = 'URL untuk navigasi saat mengklik blok. Bisa berupa tautan eksternal atau tautan internal dalam platform.';
...
$string['settings_css_heading'] = 'Font dan CSS';
...
$string['settings_mycourses_heading'] = 'Blok Kursus Saya';
...
$string['sitefonts'] = 'Font Google Tambahan';
...
$string['theme_boost_magnific_mycourses_editbooton'] = 'Edit Blok';
...
$string['theme_color_sugestion_text'] = 'Klik pada garis untuk menerapkan warna ke bidang di bawah ini:';
...
$string['top_scroll_desc'] = 'Jika diaktifkan, menu akan disematkan di bagian atas layar saat Anda menggulir halaman, memastikan akses mudah ke opsi menu.';
