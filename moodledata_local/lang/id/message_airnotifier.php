...
/**
 * Strings for component 'message_airnotifier', language 'id', version '5.0'.
 *
...
$string['encryptnotifications_help'] = 'Aktifkan enkripsi end-to-end notifikasi aplikasi. Beberapa data dapat dihapus dari notifikasi jika tidak dapat dienkripsi.';
$string['encryptprocessing'] = 'Untuk perangkat yang tidak mendukung enkripsi';
$string['encryptprocessing_desc'] = 'Pemberitahuan terenkripsi memerlukan setidaknya Android 8 atau iOS 13, dan Aplikasi Moodle 4.2 atau lebih baru.';
