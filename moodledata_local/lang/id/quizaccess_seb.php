...
/**
 * Strings for component 'quizaccess_seb', language 'id', version '5.0'.
 *
...
$string['error:ws:nokeyprovided'] = 'Setidaknya satu kunci SEB harus disediakan.';
$string['error:ws:quiznotexists'] = 'Kuis tidak ditemukan ID modul kursus yang cocok: {$a}';
...
$string['seb:manage_seb_allowcapturecamera'] = 'Ubah pengaturan kuis SEB: Izinkan akses peramban ke kamera';
$string['seb:manage_seb_allowcapturemicrophone'] = 'Ubah pengaturan kuis SEB: Izinkan akses peramban ke mikrofon';
