...
class __Mustache_1befd95a4c6aa04569934d0d33a5e75d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD0c8165c1ca7b1962a1e89bd996755a2($context, $indent, $value);
        $value = $context->find('events');
        if (empty($value)) {
...
';
    ...
    private function sectionD0c8165c1ca7b1962a1e89bd996755a2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '>
';
                $buffer .= $indent . '            <div class="activityiconcontainer small courseicon me-3">
';
